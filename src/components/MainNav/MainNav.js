...
const MainNav = () => {
    return (
        <nav className={classes.nav}>
            ...
            <input id="btn-menu" type="checkbox" className={classes.btn__menu} />
            <label htmlFor="btn-menu" className={classes.toggle}>
                <span className={classes.nav__line1}></span>
                <span className={classes.nav__line2}></span>
                <span className={classes.nav__line3}></span>
            </label>
            <ul className={classes.nav__list}>
                <li className={classes.nav__item}>Home</li>
                <li className={classes.nav__item}>Projects</li>
                <li className={classes.nav__item}>Contact</li>

                <li className={classes.nav__item}>
                    <p className={classes.nav__subtitle}>Contact</p>
                </li>
                <li className={`${classes.nav__contact} ${classes.nav__item}`}>
                    <div>Email: sebastian-010198@hotmail.com</div>
                </li>
                <li className={`${classes.nav__contact} ${classes.nav__item}`}>
                    <div>Phone: 1234567</div>
                </li>
                <li className={classes.nav__item}>
                    <p className={classes.nav__subtitle}>Address</p>
                </li>
                <li className={`${classes.nav__contact} ${classes.nav__item}`}>
                    <div>Adrress: 1234567</div>
                </li>
                <li className={`${classes.nav__contact} ${classes.nav__item}`}>
