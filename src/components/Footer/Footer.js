...
const Footer = () => {
    ...
    return (
        <footer className={Classes.footer}>
            <div className={Classes.footer__shape}>
                <svg data-rellax-speed="2" width="641" height="371" viewBox="0 0 641 371" fill="none" xmlns="http://www.w3.org/2000/svg" style={shapeStyle}>
            ...
            <div className={Classes.footer__content}>
                <ul className={Classes.footer__list}>
                    <li className={Classes.list__item}>
                        <a href="#" className={Classes.list__link}>a@a.com</a>
                    </li>
                    <li className={Classes.list__item}>
                        <a href="#" className={Classes.list__link}>+1 234 567</a>
                    </li>
                </ul>
                <ul className={Classes.social__list}>
                    <li className={Classes.list__item}>
                        <a href="#" className={Classes.list__link}>
                ...
                <div className={Classes.footer__copyright}>&copy; 2020 - Sebastian Rivera Giraldo.</div>
            </div>
        </footer>
    );
}
